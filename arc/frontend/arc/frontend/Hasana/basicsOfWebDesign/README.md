...
## Day 1
* ### Tools Setup
  * VS Code environment was set up with all the required extensions: Live Server, Prettier...
* ### Project Environment setup 
  * The main repository from the Github was forked and cloned
  * New directory and local branches for the project was set up.

* ### HTML Revision
  * Revised about header, nav, section, article, footer and id
  * Created a dummy portfolio page consisting of different sections and articles, and a link navigating to a blog page. 
